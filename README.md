...
The experimenal data file is quite large and not stored on github. Download the [crank_data](https://www.dropbox.com/scl/fo/tiybowr0f0vkru7o85gij/h?dl=0&rlkey=udwtmb0zrnlm8atrk1w6sc2uc) folder from dropbox and place it in the crankTurning-dynamicPrimitives folder. The ReadMe.txt file with in the crank_data folder provids futher details about the data set its self.
